class CfgPatches {
	class asdg_jointrails_xtra {
		units[] = {};
		weapons[] = {};
		requiredVersion = 1.48;
		requiredAddons[] = {"A3_Weapons_F_Acc","A3_Weapons_F_Mark_Acc","asdg_jointrails"};
		author[] = {"Robalo"};
	};
};
...
#define __SUPP_COEF \
	...
	class muzzle_snds_acp: muzzle_snds_H {
		...
		picture = "\asdg_jointrails_xtra\ui\gear_acca_snds_osprey";
		class ItemInfo: ItemInfo {
			__SUPP_COEF;
		};
	};

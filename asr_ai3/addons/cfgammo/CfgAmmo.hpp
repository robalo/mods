...
//        audibleFire = 32;
		dangerRadiusHit = ASR_AI_AMMO_RANGE_HIT_FAR;
	};
...
//        audibleFire = 0.25;
	...
	class BulletBase : BulletCore {
		audibleFire = ASR_AI_AMMO_AUDIBLE1; //12;
		dangerRadiusBulletClose = ASR_AI_AMMO_RANGE_CRACKS;
//        dangerRadiusHit = -1;
...
//        suppressionRadiusHit = 8;
	...
	class B_556x45_dual : B_556x45_Ball {
		audibleFire = ASR_AI_AMMO_AUDIBLE0; //4;
...
//        aiAmmoUsageFlags = "AIAmmoUsageOffensiveInf + AIAmmoUsageUnderwater";
	...
	class B_65x39_Caseless : BulletBase {
		audibleFire = ASR_AI_AMMO_AUDIBLE1; //8;
		dangerRadiusBulletClose = ASR_AI_AMMO_RANGE_CRACKS;
		dangerRadiusHit = ASR_AI_AMMO_RANGE_HIT_SMALL;
//        suppressionRadiusBulletClose = 6;
//        suppressionRadiusHit = 8;
...
//        airLock = 1;
	...
	class B_762x51_Ball : BulletBase {
		audibleFire = ASR_AI_AMMO_AUDIBLE1; //9;
		dangerRadiusBulletClose = ASR_AI_AMMO_RANGE_CRACKS;
		dangerRadiusHit = ASR_AI_AMMO_RANGE_HIT_SMALL;
//        suppressionRadiusBulletClose = 6;
//        suppressionRadiusHit = 8;
...
//        airLock = 1;
	...
	class B_12Gauge_Slug : BulletBase {
		audibleFire = ASR_AI_AMMO_AUDIBLE1; //15;
	};

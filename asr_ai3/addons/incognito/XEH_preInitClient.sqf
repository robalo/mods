...
[ QGVAR(incohint), "CHECKBOX", "Incognito hints", ["ASR AI3", "incognito"], false, 1 ] call CBA_Settings_fnc_init;
[ QGVAR(incodbg), "CHECKBOX", "Incognito debug (RPT)", ["ASR AI3", "incognito"], false, 1 ] call CBA_Settings_fnc_init;
